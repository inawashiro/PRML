...
\end{equation}
%
Additionally, taking advantage of 
%
\begin{equation}
\begin{aligned}
\int_{- \infty}^{\infty} \exp \left( - x ^ 2 \right) dx &= \Gamma \left( \frac{1}{2} \right), \\
\int_{- \infty}^{\infty} x \exp \left( - x ^ 2 \right) dx &= 0, \\
\int_{- \infty}^{\infty} x ^ 2 \exp \left( - x ^ 2 \right) dx &= \Gamma \left( \frac{3}{2} \right),
\end{aligned}
\end{equation}
%
gives
...
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3} \right) (- \lambda_3) ^ {- \frac{3}{2}} \left( \Gamma \left( \frac{3}{2} \right) + \frac{\lambda_2 ^ 2}{4 \lambda_3 ^2} \Gamma \left( \frac{1}{2} \right) \right) &= \sigma ^ 2.
\end{aligned}
\end{equation}
%
Thus,
...
%
\begin{equation}
p(x) = \left( 2 \pi \sigma ^ 2 \right) \exp \left( - \frac{1}{2 \sigma ^ 2} (x - \mu) ^ 2 \right).
\end{equation}
%
...
%
\begin{equation}
\frac{1}{2} \ln \left( 2 \pi \sigma ^ 2 \right) \int_{- \infty}^{\infty} \mathcal{N} \left( x | \mu, \sigma ^ 2 \right) dx + \frac{1}{2 \sigma ^2} \int_{- \infty}^{\infty} (x - \mu) ^ 2 \mathcal{N} \left( x | \mu, \sigma ^ 2 \right) dx = \frac{1}{2} \left( 1 + \ln \left( 2 \pi \sigma ^ 2 \right) \right).
\end{equation}
%
Thus,
%
