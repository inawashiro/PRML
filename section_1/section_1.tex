...
%%
%\begin{equation}
%p(\mathbf{y}) = p(\mathbf{A} \mathbf{x}) \abs{\det \mathbf{A} ^ {-1}},
%\end{equation}
%%
%the right hand side can be written as
%%
%\begin{equation}
%- \int p(\mathbf{A} \mathbf{x}) \abs{\det \mathbf{A} ^ {-1}} \ln \left( p(\mathbf{A} \mathbf{x}) \abs{\det \mathbf{A} ^ {-1}} \right) \mathbf{A} d\mathbf{x}
%\end{equation}
%%
