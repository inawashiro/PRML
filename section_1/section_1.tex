...
\end{equation}
%
which is clear from the definition, is used.

Finally, it is also clear from the definition that the number of independent parameters in the matrix $w_{ij}^{\rm S}$ is $\frac{D (D + 1)}{2}$.
