...
\end{equation}
%
where $\bm{\phi}$ is the polar corrdinate and $J$ is the Jacobian of the transformation from Cartesian to polar coordinate.
For a sufficiently small $\epsilon$, the integrand is constant in terms of $\phi$. 
Therefore, the right hand side can be written as $p(r) \epsilon$.
Since 
%
\begin{equation}
\int J d\phi = S_D r ^ {D - 1},
\end{equation}
%
we have
%
...
Additionally, to maximise $p(r)$, setting the derivative to zero gives
%
\begin{equation}
