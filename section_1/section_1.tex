...
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3} \right) \left( (- \lambda_3) ^ {- \frac{1}{2}} \Gamma \left( \frac{3}{2} \right) + \frac{\lambda_2 ^ 2}{4 \lambda_3 ^2} (- \lambda_3) ^ {- \frac{1}{2}} \Gamma \left( \frac{1}{2} \right) \right) &= \sigma ^ 2.
\end{aligned}
\end{equation}
%
Thus,
