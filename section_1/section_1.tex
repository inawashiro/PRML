...
\end{equation}
%
By the transformation $u = \frac{r}{\sigma}$, the right hand side can be written as
%
\begin{equation}
2 \pi \sigma ^ 2 \int_{0}^{\infty} \exp \left( - \frac{1}{2} u ^ 2 \right) u du = 2 \pi \sigma ^ 2 \left[ - \exp \left( - \frac{1}{2} u ^ 2 \right) \right]_0^\infty.
\end{equation}
%
Therefore, 
%
...
\end{equation}
%
By the transformation $z = x - \mu$, the right hand side can be written as 
%
\begin{equation}
\left( 2 \pi \sigma ^ 2 \right) ^ {- \frac{1}{2}} \int_{-\infty}^{\infty} \exp \left( -\frac{1}{2 \sigma ^ 2} z ^ 2 \right) dz = \left( 2 \pi \sigma ^ 2 \right) ^ {- \frac{1}{2}} I.
\end{equation}
%
Therefore,
%
