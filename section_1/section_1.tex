...
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3} \right) \int_{- \infty}^{\infty} \left( (- \lambda_3) ^ {- \frac{1}{2}} y + \mu - \frac{\lambda_2}{2 \lambda_3} \right) ^ 2 \exp \left( - y ^ 2 \right) (- \lambda_3) ^ {- \frac{1}{2}} dy &= \sigma ^ 2.\\
\end{aligned}
\end{equation}
%
Since
...
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3} \right) \left( (- \lambda_3) ^ {- \frac{3}{2}} \Gamma \left( \frac{3}{2} \right) + (- \lambda_3) ^ {- \frac{1}{2}} \left( \mu - \frac{\lambda_2}{2 \lambda_3} \right) ^ 2 \Gamma \left( \frac{1}{2} \right) \right) &= \sigma ^ 2.
\end{aligned}
\end{equation}
%
Thus,
...
%\subsection{}
%Let $f$ be a be strictly convex function.
%By the definition,
%%
%\begin{equation}
